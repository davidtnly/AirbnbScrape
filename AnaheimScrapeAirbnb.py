...
Scraping Airbnb
Edited by David for Anaheim--CA 2015
"""
...
def IterateMainPage(location_string, loop_limit, offset): 
    ...
    try:
        for n in range(offset+1, offset+loop_limit+1):
...
def ParseMainXML(url= 'https://www.airbnb.com/s/Anaheim--CA--United-States', pg = 0):
...
if __name__ == '__main__':
    ...
    MainResults = IterateMainPage('Anaheim--CA', 20,0)

    # create a new array of results (start empty)
    # loop through main results
    # if the bed is 4,5,6, add to new array
    # return new array
